        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <button type="button" class="btn btn-primary align-items-center donor-btn" style="margin-left: 20px;">
                                {{ __('As a Donor') }}
                            </button>
                        </div>
                        <div class="col">
                            <button type="button" class="btn btn-primary align-items-center center-btn" >
                                {{ __('As a Blood Center') }}
                            </button>
                        </div>
                    </div>
                    <form id="donor-form" method="POST" action="{{ route('donor.register') }}">
                        @csrf
                    ...
                    <form id="center-form" method="POST" action="{{ route('center.register') }}" style="display: none;">
                        @csrf
                        ...
                        <div class="row mb-3">
                            <label for="postal" class="col-md-4 col-form-label text-md-end">{{ __('Postal ID') }}</label>
